...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var gameEngineContext = new PokerGame.Core.Messaging.ExecutionContext("static_game_engine_service", "Game Engine Test", 5555, 5556);
        var consoleUIContext = new PokerGame.Core.Messaging.ExecutionContext("static_console_ui_service", "Console UI Test", 5557, 5558);
