...
echo "Building the Core project specifically..."
cd /home/runner/workspace
dotnet build PokerGame.Core/PokerGame.Core.csproj -c Release

echo "Creating test project for MessageBroker..."
mkdir -p MessageBrokerTest
cd MessageBrokerTest

cat > MessageBrokerTest.csproj << 'EOF'
